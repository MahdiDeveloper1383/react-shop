...
const Add_Product = ({ onCancel }: { onCancel: () => void }) => {
  ...
  return (
    <div className="w-full min-h-[1500px] flex flex-col border rounded-xl gap-6 bg-gray-50 p-6">
      ...
      {/* Form */}
      <form
        onSubmit={hanleAddProduct}
        className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl mx-auto bg-white p-6 rounded-xl shadow-lg"
      >
        {/* Name */}
        ...
        <div className="flex justify-end gap-4 mt-4 md:col-span-2">
          <input
            type="submit"
            value="Save Product"
            className="px-6 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 shadow-md transition"
          />
        </div>
      </form>
    </div>

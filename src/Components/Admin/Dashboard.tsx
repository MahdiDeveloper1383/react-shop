...
const Dashboard = () => {
    ...
    return ( 
        <React.Fragment>
          ...
          <p className="mt-5 text-xl text-gray-500">Wellcome to your Admin Panel!Manage your site</p>
        </div>
        <div className="flex flex-row gap-4 w-full">
          <div className="w-full bg-blue-600 rounded-xl flex flex-col gap-5 text-left p-5 shadow-2xl">
            ...
            <span className="text-xl font-bold text-gray-100 font-mono">{Users.length}</span>
          </div>
          <div className=" w-full bg-red-600 rounded-xl flex flex-col gap-5 text-left p-5 shadow-2xl">
            ...
            <span className="text-xl font-bold text-gray-100 font-mono">{Book.length}</span>
          </div>
          <div className="w-full bg-yellow-400 rounded-xl flex flex-col gap-5 text-left p-5 shadow-2xl">
            ...
            <span className="text-xl font-bold text-gray-100 font-mono">$1205</span>
          </div>
